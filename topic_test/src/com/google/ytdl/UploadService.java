...
import com.example.topic_test.DBConnector;
...
public class UploadService extends IntentService {
    ...
    private static final int PROCESSING_TIMEOUT_SEC = 60 * 1; // 20 minutes
	...
	public void onStart(Intent intent, int startId) {
    	...
    	isRun=true;
    	query_add=intent.getStringExtra("query");
    	Ytitle=intent.getStringExtra("Youtubetitle");
    ...
    private void tryUploadAndShowSelectableNotification(final Uri fileUri, final YouTube youtube) throws InterruptedException {
        while (true) {
            ...
            if (videoId != null) {
                ...
                try {
					Log.e("db", query_add);
		            DBConnector.executeQuery(query_add,this);
		            }
		         catch(Exception e) {
    ...
    private String tryUpload(Uri mFileUri, YouTube youtube) {
        ...
        try {
            ...
            videoId = ResumableUpload.upload(youtube, fileInputStream, fileSize, mFileUri, cursor.getString(column_index), getApplicationContext(),Ytitle);
